...
void getMoverpunto(); //numero 19                    mover punto
void getCajero(); //numero 20                      simulacion de un cajero
void getHipotenusa(); //numero 21                  encuentra la hipotenusa
void getNumeromayor(); //numero 22                 Numero mayor
void getGrados();     //nuermo 23                   de faren a celsius
void getCalcularedad(); //numero 24                 calcula la edad de una persona
void getPromedio();  //numero 25                    calcular el promedio escolar
...
main()
{
   ...
   { 
      ...
      cout<<"\n\n----------MENU----------\n"<<endl;
        ...
        cout<<" 22) Numero mayor.\n"<<endl;
        cout<<" 23) De grados Fahrenheit a Celsius.\n"<<endl;
        cout<<" 24) Calcular la edad de una persona.\n"<<endl;
        cout<<" 25) Calcular el promedio escolar.\n"<<endl;
        cout<<" 26) Salir.\n"<<endl;
        ...
        switch(op){
			...
			case 22:
               system("cls");
			   getNumeromayor();               //numero mayor      	
        	   system("pause");
            break; 
			
			case 23:
               system("cls");
			   getGrados();                    //de faren a celsius      	
        	   system("pause");
            break;
			...
			case 25:
               system("cls");
			   getPromedio();                    //calcular el promedio escolar                    	
        	   system("pause");
            break;     
...
void getMoverpunto(){         //numero 19 nmover punto por pantalla
...
void getCalcularedad(){
int N; //año nacimiento
int A; //año actual
int r; //edad
cout<<"Determina la edad de una persona con saber el año en que nacio y el año actuañ."<<endl;
cout<<"Ingrese la edad de nacimiento: ";
cin>>N;
cout<<"Ingrese el año actual: ";
cin>>A;
r = N - A;
cout<<"La edad es de: "<<r<<" años"<<endl;
...
cout<<"Calcular el promedio del año escolar."<<endl;
cout<<"Ingrese el Primer punteo: ";
cin>>n1;
cout<<"Ingrese el segundo punteo: ";
cin>>n2;
cout<<"Ingrese el tercer punteo: ";
cin>>n3;
cout<<"Ingrese el cuarto punteo: ";
cin>>n4;

P = (n1 + n2 + n3 + n4) / 4;
cout<<"Su promedio escolar es de: "<<P<<endl;
cout<<endl;
